            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=255,
                        verbose_name="complicated",
                    ),
                ),
                (
                    "is_possible_to_make",
                    models.BooleanField(
                        default=False, verbose_name="is possible to make"
                    ),
                ),
                (
                    "date_creation",
                ...
                (
                    "date_modified",
                    models.DateField(auto_now=True, verbose_name="Date modified"),
                ),
            ],
            options={
                "verbose_name": "orders",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("LIQUID", "liquid"), ("OTHER", "other")],
                        max_length=255,
                        verbose_name="type",
                    ),
                ),
                (
                    "unit",
                    models.CharField(
                        choices=[("MILLILITER", "milliliter"), ("PIECE", "piece")],
                        max_length=255,
                        verbose_name="unit",
                    ),
                ),
                (
                    ...
                    models.FileField(
                        null=True,
                        upload_to="D:\\Coding\\Bartender_Assistant/static/media",
                        verbose_name="image",
                    ),
                ),
                (
